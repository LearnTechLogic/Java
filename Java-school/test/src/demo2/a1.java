...
public class a1 {
    public static void main(String[] args) {
        ...
        /********* begin *********/
        Person0 person1 = new Chinese(cName,cSex,cAge);
        showEat(person1);
        Person0 person2 = new English(eName,eSex,eAge);
        showEat(person2);
        /********* end *********/
    ...
    /********* begin *********/
    public static void showEat(Person0 p){
        p.eat();
    }
    /********* end *********/
}
...
abstract class Person0 {
    ...
    String sex;
    int age;
    public Person0(String name,String sex,int age){
        this.name = name;
        this.sex = sex;
        this.age = age;
    }
...
class English extends Person0 {
    /********* begin *********/
    public English(String name,String sex,int age){
        super(name,sex,age);
    }
    public void eat(){
        System.out.println("姓名：" + name + "，性别：" + sex + "，年龄：" + age + "，我是英国人，我喜欢三明治！");
    }
